...
INPUT_FILES = [
    ("output_quill/Chapter_19_UltraDense.md", "DEADPOOL & WOLVERINE: CHAPTER 19 (ULTRA-DENSITY)"),
    ("output_quill/Chapter_20_UltraDense.md", "DEADPOOL & WOLVERINE: CHAPTER 20 (ULTRA-DENSITY)")
]
