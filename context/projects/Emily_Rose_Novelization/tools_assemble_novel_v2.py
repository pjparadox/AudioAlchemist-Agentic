...
def create_manuscript():
    # Input files - Grouped by phase
    files = [
        "context/projects/Emily_Rose_Novelization/output_quill/Chapter_01_06.txt",
        "context/projects/Emily_Rose_Novelization/output_quill/Chapter_07_12.txt",
    ...
    for line in full_text.split('\n'):
        ...
        if line.startswith('# Chapter') or line.startswith('***'):
            # Convert markdown header to docx header
