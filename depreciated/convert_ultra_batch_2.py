...
INPUT_FILES = [
    ("output_quill/Chapter_5_UltraDense.md", "DEADPOOL & WOLVERINE: CHAPTER 5 (ULTRA-DENSITY)"),
    ("output_quill/Chapter_6_UltraDense.md", "DEADPOOL & WOLVERINE: CHAPTER 6 (ULTRA-DENSITY)")
]
