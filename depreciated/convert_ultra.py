...
INPUT_FILE = "output_quill/Chapter_1_UltraDense.md"
OUTPUT_DOCX = "output_quill/Deadpool_Wolverine_Chapter1_Ultra.docx"
OUTPUT_DOC = "output_quill/Deadpool_Wolverine_Chapter1_Ultra.doc"
OUTPUT_PDF = "output_quill/Deadpool_Wolverine_Chapter1_Ultra.pdf"

def create_docx(text, filepath):
    doc = Document()
    doc.add_heading('DEADPOOL & WOLVERINE: CHAPTER 1 (ULTRA-DENSITY)', 0)
