...
INPUT_FILE = "output_quill/Deadpool_Wolverine_Vol2_Bestseller.txt"
OUTPUT_DOCX = "output_quill/Deadpool_Wolverine_Vol2_Bestseller.docx"
OUTPUT_DOC = "output_quill/Deadpool_Wolverine_Vol2_Bestseller.doc"
OUTPUT_PDF = "output_quill/Deadpool_Wolverine_Vol2_Bestseller.pdf"

def create_docx(text, filepath):
    doc = Document()
    doc.add_heading('DEADPOOL & WOLVERINE: VOLUME 2 (BESTSELLER EDITION)', 0)
