...
INPUT_FILE = "output_quill/Deadpool_Wolverine_Novelization_Vol1.txt"
OUTPUT_DOCX = "output_quill/Deadpool_Wolverine_Novelization_Vol1.docx"
OUTPUT_DOC = "output_quill/Deadpool_Wolverine_Novelization_Vol1.doc"
OUTPUT_PDF = "output_quill/Deadpool_Wolverine_Novelization_Vol1.pdf"

def create_docx(text, filepath):
    doc = Document()
    doc.add_heading('DEADPOOL & WOLVERINE: VOLUME 1', 0)
