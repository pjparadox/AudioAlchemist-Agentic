...
INPUT_FILES = [
    ("output_quill/Chapter_13_UltraDense.md", "DEADPOOL & WOLVERINE: CHAPTER 13 (ULTRA-DENSITY)"),
    ("output_quill/Chapter_14_UltraDense.md", "DEADPOOL & WOLVERINE: CHAPTER 14 (ULTRA-DENSITY)")
]
