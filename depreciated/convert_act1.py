...
INPUT_FILE = "output_quill/Deadpool_Wolverine_Novelization_Act1_Full.txt"
OUTPUT_DOCX = "output_quill/Deadpool_Wolverine_Novelization_Act1_Full.docx"
OUTPUT_DOC = "output_quill/Deadpool_Wolverine_Novelization_Act1_Full.doc"
OUTPUT_PDF = "output_quill/Deadpool_Wolverine_Novelization_Act1_Full.pdf"

def create_docx(text, filepath):
    doc = Document()
    doc.add_heading('DEADPOOL & WOLVERINE: ACT I (DIRECTOR\'S CUT)', 0)
