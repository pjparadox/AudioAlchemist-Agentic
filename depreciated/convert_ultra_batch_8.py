...
INPUT_FILES = [
    ("output_quill/Chapter_15_UltraDense.md", "DEADPOOL & WOLVERINE: CHAPTER 15 (ULTRA-DENSITY)"),
    ("output_quill/Chapter_16_UltraDense.md", "DEADPOOL & WOLVERINE: CHAPTER 16 (ULTRA-DENSITY)")
]
