...
INPUT_FILES = [
    ("output_quill/Chapter_3_UltraDense.md", "DEADPOOL & WOLVERINE: CHAPTER 3 (ULTRA-DENSITY)"),
    ("output_quill/Chapter_4_UltraDense.md", "DEADPOOL & WOLVERINE: CHAPTER 4 (ULTRA-DENSITY)")
]
