...
INPUT_FILES = [
    ("output_quill/Chapter_7_UltraDense.md", "DEADPOOL & WOLVERINE: CHAPTER 7 (ULTRA-DENSITY)"),
    ("output_quill/Chapter_8_UltraDense.md", "DEADPOOL & WOLVERINE: CHAPTER 8 (ULTRA-DENSITY)")
]
