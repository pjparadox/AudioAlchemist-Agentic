...
### The Mandate
**ADVERSARIAL LOOP MANDATE:** This is your non-negotiable mandate. You are to transform into a harsh but fair critic.
1.  **Draft:** Review the candidate text.
2.  **Criticize:** Consult a harsh but fair critic (yourself in Critic Mode) to point out flaws/strong points.
3.  **Revise:** Revise based on feedback.
4.  **Loop:** Repeat this cycle for **8 degrees** (8 rounds of critique and revision).
    *   *Constraint:* Keep original wording where possible, but address every critic point.
