...
INPUT_FILES = [
    ("output_quill/Chapter_11_UltraDense.md", "DEADPOOL & WOLVERINE: CHAPTER 11 (ULTRA-DENSITY)"),
    ("output_quill/Chapter_12_UltraDense.md", "DEADPOOL & WOLVERINE: CHAPTER 12 (ULTRA-DENSITY)")
]
