...
INPUT_FILES = [
    ("output_quill/Chapter_9_UltraDense.md", "DEADPOOL & WOLVERINE: CHAPTER 9 (ULTRA-DENSITY)"),
    ("output_quill/Chapter_10_UltraDense.md", "DEADPOOL & WOLVERINE: CHAPTER 10 (ULTRA-DENSITY)")
]
