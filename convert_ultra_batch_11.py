...
INPUT_FILES = [
    ("output_quill/Chapter_21_UltraDense.md", "DEADPOOL & WOLVERINE: CHAPTER 21 (ULTRA-DENSITY)"),
    ("output_quill/Chapter_22_UltraDense.md", "DEADPOOL & WOLVERINE: CHAPTER 22 (ULTRA-DENSITY)")
]
